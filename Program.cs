...
using MovieRecommend.DataStructures;
using System.IO;
using Common;
...
namespace MovieRecommend
{
    class Program
    {
        ...
        private static string MoviesDataLocation = $"{DatasetsRelativePath}/recommendation-movies.csv";
        ...
        private static string TrainingDataLocation = TrainingDataRelativePath;
        private static string TestDataLocation = TestDataRelativePath;
        private static string ModelPath = ModelsRelativePath;
        ...
        static void Main(string[] args)
        {
            ...
            ConsoleHelper.PeekDataViewInConsole(mlcontext, trainingDataView, dataProcessingPipeline, 10);
